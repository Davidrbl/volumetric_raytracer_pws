...
#include "imgui.h"
#ifdef IMGUI_ENABLE_FREETYPE
#include "cimgui/imgui/misc/freetype/imgui_freetype.h"
#endif
...
CIMGUI_API bool igImplGlfw_InitForOpenGL(GLFWwindow* window, bool install_callbacks)
{
    return ImGui_ImplGlfw_InitForOpenGL(window, install_callbacks);
}

CIMGUI_API void igImplGlfw_Shutdown()
{
    return ImGui_ImplGlfw_Shutdown();
}

CIMGUI_API void igImplGlfw_NewFrame()
{
...
CIMGUI_API void igImplOpenGL3_RenderDrawData(ImDrawData* drawdata)
{
    return ImGui_ImplOpenGL3_RenderDrawData(drawdata);
}

// my stuff (david) ^
// actually generated stuff down
